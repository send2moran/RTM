...
function dart_precompiled($collectedClasses) {
  ...
  Focus.builtin$cls = "Focus";
  if (!"name" in Focus)
    Focus.name = "Focus";
  $desc = $collectedClasses.Focus;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Focus.prototype = $desc;
